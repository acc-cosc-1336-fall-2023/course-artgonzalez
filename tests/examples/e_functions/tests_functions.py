...
from src.examples.e_functions.value_return_functions import get_random_number, global_variable, local_function_variable, return_two_function_values, test_config
